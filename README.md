## 2023 Spring USC DSCI_553 (Foundations and Applications of Data Mining) Homeworks Respority
...
|---|------------------------|-----------|----|-----|
|1|[Data Exploration](https://github.com/AaronYang2333/INF_553/blob/master/hw_pdf/assignment1.pdf)|[Python](https://github.com/AaronYang2333/INF_553/tree/master/ay_hw_1) |`MapReduce` `Spark` `Pyspark`|7.0 (python) + 0.0 (scala) / 7.0 + 0.7|
...
|-|[Hybrid Recommendation System](https://github.com/AaronYang2333/INF_553/tree/master/project/pdf/project_description.pdf)|[Code](https://github.com/AaronYang2333/INF_553/tree/master/project/python)|`User Based Collaborative Filtering` `Baseline` `Model Stacking`|RMSE: 0.9772904711772428|
